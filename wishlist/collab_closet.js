...
function displayCollections() {
    ...
    //         items: womensData.slice(0, 4) // Assuming womensData is the array of items
    //     },
    //     {
    //         owner: "Nishtha",
    //         profilePicture: "/Common Files/image/profile one.jpeg",
    ...
    for (var collectionName in collections) {
        ...
        collectionBox.append(collectionTitle);
        collectionBox.append(document.createElement("hr"));
        // Creating two horizontal partitions
        profiles.forEach((profile, index) => {
            var partitionBox = document.createElement("div");
            partitionBox.classList.add("partition-box");
            ...
            profileTitle.textContent = profile.owner;

            profileContainer.append(profileImg, profileTitle);

            var itemsContainer = document.createElement("div");
            itemsContainer.classList.add("items-container");

            profile.items.forEach(function (item, itemIndex) {
            ...
            partitionBox.append(profileContainer, itemsContainer);
            collectionBox.append(partitionBox);
        });
